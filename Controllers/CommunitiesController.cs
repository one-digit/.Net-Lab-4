...
namespace Lab4.Controllers
{
    public class CommunitiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Title,Budget,MembershipID")] Community community)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("ID,Title,Budget,MembershipID")] Community community)
        {
            if (id != community.ID)
            {
                return NotFound();
